    ...
    <main>
      ...
      <div class="content-container w-full">
        <section class="content-card" >
          ...
          <h2>Flexibel, spontan mit dem Sound einer Band</h2>
          ...
          <p>Dieses Projekt eignet sich hervorragend für verschiedene Anlässe und Veranstaltungen. Überall wo es luftige, lockere Beats mit jazzigem Saxophon und einer ordentlicheen Portion Soul benötigt..
          </p>
        ...
        <h3>Elektro &  Sax</h3>
        <p>Ich produziere seit meiner Schulzeit elektronische Musik, die ich auch auflege und dazu Saxophon spiele. <br />Ich lege hierbei nur sehr ausgewählte Sounds auf und bin nicht als DJ in dieser Form unterwegs. </p>
        <h4>Rooftop Bars, Afterwork, Open Air Events..</h4>
        <p>Wer liebt es nicht? <br />
        Ein kühles Getränk, schönes Wetter und ein triebende eletronische Beats mit mal Funky, mal sphärischen Saxophon Sounds.</p>

        <p>Meistens spiele ich aber zusammen mit meinem Kollegen und langjährigen Freund <a class="link" href="https://www.bikebalance.de/">Christian Gehrmann</a> <br />  Urbane Elektro Sounds, gepaart mit Funky Saxophon Riffs!</p>
